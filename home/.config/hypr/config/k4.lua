...
local mod = "SUPER"
local raiz = "/home/arjun/.config/quickshell/k4"
...
hl.bind(mod .. " + SHIFT + I", hl.dsp.exec_cmd(k4 .. "togglePanel"))
hl.bind(mod .. " + X", hl.dsp.exec_cmd(k4 .. "togglePanel"))
hl.bind(mod .. " + ALT + N", hl.dsp.exec_cmd(k4 .. "toggleNotifications"))
--hl.bind(mod .. " + ALT + A", hl.dsp.exec_cmd(k4 .. "toggleNotifications"))
hl.bind(mod .. " + SHIFT + Z", hl.dsp.exec_cmd(k4 .. "settings"))
...
hl.bind(mod .. " + ALT + W", hl.dsp.exec_cmd(k4 .. "theme"))
...
--scp Nada de ALT + Print: con Alt pulsado el kernel convierte esa tecla en SysRq y
